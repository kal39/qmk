...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ansi(
    ...
    _______, _______, _______, _______,                   KC_BTN1,                            DM_REC1, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R
  ),
  [2] = LAYOUT_ansi(
    ...
    _______, _______, _______, _______,                   KC_BTN2,                            DM_RSTP, _______, _______, KC_WH_L, KC_WH_D, KC_WH_R
  ),
};
